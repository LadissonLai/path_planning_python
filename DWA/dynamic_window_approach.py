...
class Config:
    ...
    def __init__(self):
        ...
        self.max_yaw_rate = 40.0 * math.pi / 180.0  # [rad/s] 角速度
        self.max_accel = 0.2  # [m/ss] 加速度
        self.max_delta_yaw_rate = 40.0 * math.pi / 180.0  # [rad/ss] 角加速度
...
def motion(x, u, dt):
    """
    motion model, 使用最简单的航迹推算模型，更新车辆状态。都不是车辆的运动学模型。
    """
...
def calc_control_and_trajectory(x, dw, config: Config, goal, ob):
    """
